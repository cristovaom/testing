    ...
    <>
      <Dialog>
        <DialogHeader>
          ...
          <DialogDescription>
            Preencha as informações necessarias para editar o veículo da frota!
          </DialogDescription>
        </DialogHeader>
        <Separator />
        <DialogDescription>
          <form onSubmit={handleSubmit(handleSubmitForm)}>
            <section className="flex justify-center flex-col gap-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <Input placeholder="Kangoo" {...register("modelo")} />
                {errors.modelo && (
                  <span className="text-red-500 text-xs">
              ...
              <div className="flex items-center gap-4">
                ...
                <Input placeholder="2018" {...register("ano")} />
                <div>
                  {errors.ano && (
                    <span className="text-red-500 text-xs">
                      {errors.ano.message}
              ...
              <div className="flex items-center gap-4">
                ...
                <Input placeholder="BCTY-2843" {...register("placa")} />
                {errors.placa && (
                  <span className="text-red-500 text-xs">
              ...
              <div className="flex items-center gap-4">
                ...
                <Input placeholder="5134812343214" {...register("renavam")} />
                {errors.renavam && (
                  <span className="text-red-500 text-xs">
              ...
              <div className="flex items-center gap-4">
                ...
                <Input placeholder="5134-1234" {...register("chassis")} />
                {errors.chassis && (
                  <span className="text-red-500 text-xs">
